...
export const getLoginModalStatus = (state) => state.modal.value.login.isOpen;
export const getRegisterModalStatus = (state) => state.modal.value.register.isOpen;
...
export const setModalWidth = (modalObj) => (state) => {
